...
CREATE TABLE users (
    ...
    phone VARCHAR(20),
    address TEXT,
    user_type ENUM('Administrator', 'Teacher', 'Member'),
    password VARCHAR(255), -- Encrypted password storage
...
CREATE TABLE member_details (
    ...
    medical_file TEXT,
    pathology TEXT,
    fitness_level ENUM('High', 'Medium', 'Low'),
...
CREATE TABLE profile_images (
    ...
    member_id INT,
    image_type ENUM('Photo', 'Document'),
...
CREATE TABLE groups (
    ...
    capacity INT,
    group_type ENUM('Pilates', 'Muscle Training'),
    level ENUM('F2', 'F3')
);
...
CREATE TABLE messages (
    ...
    content TEXT,
    send_date DATETIME,
    message_type ENUM('Group', 'Individual'),
    sender_id INT,
    recipient_id INT,
    group_id INT,
