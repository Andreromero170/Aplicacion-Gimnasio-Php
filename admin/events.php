...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Inicio</a> <a href="#" class="current">Eventos</a> </div>
    <h1 class="text-center">Lista de Eventos <i class="fas fa-calendar-alt"></i></h1>
  </div>
    ...
    <div class="row-fluid">
      ...
      <div class='widget-box'>
          ...
          if (isset($_POST['search'])) {
              ...
              // Consulta SQL para buscar eventos por nombre
              $qry = "SELECT id, nombre, cantidad_inscritos, costo FROM eventos WHERE nombre LIKE '%$search%'";
          } else {
              // Consulta SQL para obtener todos los eventos
              $qry = "SELECT id, nombre, cantidad_inscritos, costo FROM eventos";
          }
          ...
          while ($row = mysqli_fetch_array($result)) {
              echo "<tbody> 
                      <tr>
                        ...
                        <td><div class='text-center'>".$row['cantidad_inscritos']."</div></td>
                        <td><div class='text-center'>$".$row['costo']."</div></td>
                        <td><div class='text-center'><a href='edit-event-form.php?id=".$row['id']."'><i class='fas fa-edit'></i> Editar</a></div>
                    <div class='text-center'><a href='actions/delete-event.php?id=".$row['id']."' style='color:#F66;'><i class='fas fa-trash'></i> Eliminar</a></div></td>
                      </tr>
                    </tbody>";
              $cnt++;  
          }
