...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="fas fa--home"></i>Inicio</a> <a href="#" class="current">Miembros por Grupos</a> </div>
  ...
  <div class="container-fluid">
    ...
    <div class="row-fluid">
      ...
      <div class='widget-box'>
         ...
         // Consulta SQL para obtener los grupos y la disponibilidad de cupos
         $qry = "SELECT 
                     g.id_grupo,
                     g.nombre_grupo, 
                     COUNT(mg.id_usuario) AS miembros_asignados,
                     g.cupos_disponibles,
                     (g.cupos_disponibles - COUNT(mg.id_usuario)) AS cupos_restantes
                 FROM grupos g
                 LEFT JOIN miembro_grupo mg ON g.id_grupo = mg.id_grupo
                 GROUP BY g.id_grupo";
         ...
         while ($row = mysqli_fetch_assoc($result)) {
             echo "<tbody>
                     <tr>
                       ...
                       <td>".$row['miembros_asignados']."</td>
                       <td>".$row['cupos_disponibles']."</td>
                       <td>".($row['cupos_disponibles'] - $row['miembros_asignados'])."</td>
                       <td><a href='detalles_grupo.php?id_grupo=".$row['id_grupo']."' class='btn btn-primary'>Detalles</a></td>
                     </tr>
                   </tbody>";
         }
