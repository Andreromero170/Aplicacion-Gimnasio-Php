...
<?php $page='group-result'; include 'includes/sidebar.php'?>
<div id="content">
    <div id="content-header">
        ...
        <h1 class="text-center">Lista de Grupos <i class="fas fa-group"></i></h1>
    </div>
                    ...
                    <div class='widget-content nopadding'>
                        ...
                        if (!empty($searchTerm)) {
                            $qry = "SELECT 
                                        ...
                                        g.cupos_disponibles
                                    FROM grupos g
                                    WHERE g.nombre_grupo LIKE '%$searchTerm%' 
                                    OR g.cupos_disponibles LIKE '%$searchTerm%'";
                        } else {
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            echo "<tbody> 
                                   ...
                                   <td> <div class='text-center'><a href='actions/delete-group-general.php?id=".$row['id_grupo']."' style='color:#F66;'><i class='fas fa-trash'></i> Eliminar</a></div></td>
