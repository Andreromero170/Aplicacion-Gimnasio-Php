...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (!empty($campos_faltantes)) {
      ...
      // Obtener la fecha de registro como fecha inicial de pago y establecer el estado como "Pendiente"
$fecha_pago = $fecha_registro;
$estado_pago = 'Pendiente';

// Insertar en la tabla pagos_mensuales con el estado "Pendiente" y usando la fecha de registro
$fecha_proximo_pago = date("Y-m-d", strtotime("+1 month", strtotime($fecha_pago)));
$qry_pago = "INSERT INTO pagos_mensuales (id_usuario, fecha_pago, fecha_proximo_pago, estado_pago)
             VALUES ('$miembro_id', '$fecha_registro', '$fecha_proximo_pago', '$estado_pago')";
$conn->query($qry_pago);
          ...
          echo "<div class='error_ex'>";
          echo "<h1>Éxito</h1>";
          echo "<h3>¡Los detalles del miembro han sido añadidos y el pago registrado!</h3>";
