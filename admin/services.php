...
<!--sidebar-menu-->
<?php $page = 'tarifas-update'; include 'includes/sidebar.php' ?>

<div id="content">
  <div id="content-header">
    <div id="breadcrumb">
        <a href="#" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i>Inicio</a>
        <a href="#" class="current">Tarifas Registradas</a>
    </div>
    <h1 class="text-center">Lista de Tarifas Registradas</h1>
  </div>
    ...
    <div class="row-fluid">
      ...
      <div class='widget-box'>
          <div class='widget-title'>
            ...
            <form id="custom-search-form" role="search" method="POST" action="search-result-services.php" class="form-search form-horizontal pull-right">
          ...
          if (isset($_POST['search'])) {
              ...
              // Consulta SQL para buscar por nombre o costo
              $qry = "SELECT 
                          id, 
                          nombre, 
                          costo 
          ...
          while ($row = mysqli_fetch_array($result)) {
              echo "<tbody>
                   ...
                   <td><div class='text-center'><a href='edit-groupform.php?id_servicio=".$row['id']."'><i class='fas fa-edit'></i> Editar</a></div>
                        <div class='text-center'><a href='actions/delete-tarifa.php?id=".$row['id']."' style='color:#F66;'><i class='fas fa-trash'></i> Eliminar</a></div></td>
                      </tr>
                    </tbody>";
              $cnt++;
          }
