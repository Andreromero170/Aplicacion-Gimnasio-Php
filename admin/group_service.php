...
<div id="content-header">
  <div id="breadcrumb"> <a href="#" class="tip-bottom"><i class="fas fa-home"></i>Inicio</a> <a href="#" class="tip-bottom">Administracion de Grupos y Servicios</a></div>
...
<div class="container-fluid">
  ...
  <div class="row-fluid">
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="add-group-req.php" method="POST" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">Nombre del Grupo :</label>
              <div class="controls">
                <input type="text" class="span11" name="nombre_grupo" placeholder="Nombre del Grupo" />
              </div>
            </div>
            <div class="control-group">
    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
        <form action="add-service-req.php" method="POST" class="form-horizontal">
  ...
  <div class="controls">
  <input type="text" class="span11" name="nombre_servicio" placeholder="Nombre del Servicio" />
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <div class="input-append">
                  ...
                  <input type="texto" placeholder="" name="costo" class="span11">
                  </div>
              </div>
            </div>
