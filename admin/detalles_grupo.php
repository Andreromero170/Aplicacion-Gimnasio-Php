...
<div id="content">
    ...
    <form id="custom-search-form" role="search" method="POST" action="search-result-group.php?id_grupo=<?php echo $id_grupo; ?>" class="form-search form-horizontal pull-right">
        ...
        <button type='submit' class='btn btn-success w-100' name='estado_asistencia' value='Asistió'>
                Asistió
            </button>
            <button type='submit' class='btn btn-warning w-100' name='estado_asistencia' value='Faltó con Aviso'>
                Faltó con Aviso
            </button>
            <button type='submit' class='btn btn-danger w-100' name='estado_asistencia' value='Faltó sin Aviso'>
                Faltó sin Aviso
            </button>
