...
<div id="content">
    <div id="content-header">
        ...
        <h1 class="text-center">Lista de Miembros Registrados - Grupo: <strong><?php echo $group_name; ?></strong> <i class="fas fa-group"></i></h1>
    </div>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class='widget-box'>
                    ...
                    // Modificar la consulta para filtrar por nombre completo
                    $qry = "SELECT * FROM miembros m 
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        echo "<tbody> 
                            ...
                            <button type='submit' class='btn btn-success' name='estado_asistencia' value='Asistió'>Asistió</button>
                            <button type='submit' class='btn btn-warning' name='estado_asistencia' value='Faltó con Aviso'>Faltó con Aviso</button>
                            <button type='submit' class='btn btn-danger' name='estado_asistencia' value='Faltó sin Aviso'>Faltó sin Aviso</button>
                        </form>
                                    </td>
                                </tr>
                              </tbody>";
